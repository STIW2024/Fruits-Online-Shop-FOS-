                ...
                if (isEmailValid) {
                    if (pass.length() > 7) {
                        if (pass.equals(passAgain)) {
                            ...
                            String sql = "INSERT INTO  `fruits_online_shop`.`user` "
                    ...
                    } //or the paasword length is less than 9
                    else {
                        isRegistered = false;
                        message = "Password length is less than 9 characters";
                        messageDetail = "Please provide a passwords that has password length of minimum of nine alphanumeric characters";
                        out.print(" Not Success!! the paasword length is less than 9");
                    }
                } //or email is wrong
                else {
                    isRegistered = false;
