<%-- 
    Document   : insertdb
    Created on : Dec 19, 2017, 5:08:00 PM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <sql:update dataSource="${dbsource}" var="result">
            INSERT INTO product(product_name, sub_category_name, category_name, company_name, price, summary, tags, product_qty, lastUpdated, hits ) VALUES (?,?,?,?,?,?,?,?,?,?);
