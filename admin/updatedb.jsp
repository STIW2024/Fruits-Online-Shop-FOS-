<%-- 
    Document   : updatedb
    Created on : Dec 19, 2017, 5:12:50 PM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <sql:update dataSource="${dbsource}" var="count">
            UPDATE product SET product_name = ?, sub_category_name = ?, category_name = ?, company_name = ?, price = ?, summary = ?, tags = ?, product_qty = ?, lastUpdated = ?, hits = ?
